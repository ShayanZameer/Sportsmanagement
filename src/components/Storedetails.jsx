    ...
    return (
        <div className='flex items-center border-b-2 px-3 py-3'>
            ...
            <div className="mb-1 flex-1 flex justify-start" >
                ...
                <svg onClick={toggleWarning} cursor="pointer" color='#48525B' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
